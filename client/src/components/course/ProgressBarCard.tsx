      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-1">
        ...
        <div className="text-xs text-dark-textMuted font-mono space-y-0.5">
          ...
          {course.totalChapters > 0 && (
            <div className="text-[11px] text-cyanAccent font-semibold">
          ...
          <div className="flex items-center gap-2">
            {course.totalChapters > 0 && (
              <button
                ...
                className="group flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-dark-surface text-cyanAccent border border-cyanAccent/30 hover:bg-cyanAccent/10 hover:border-cyanAccent/60 active:scale-95 transition-all duration-200 text-xs font-medium"
